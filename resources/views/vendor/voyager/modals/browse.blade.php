                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('edit', $data)
                                                <a href="{{ route('voyager.modal-blocks.edit', $data->{$data->getKeyName()}) }}" title="{{ __('Block Content') }}" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">{{ __('Block Content') }}</span>
                                                </a>
                                                <a href="{{ route('voyager.modals.edit', $data->{$data->getKeyName()}) }}" title="{{ __('voyager::generic.settings') }}" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-settings"></i> <span class="hidden-xs hidden-sm">{{ __('voyager::generic.settings') }}</span>
                                                </a>
                                            @endcan
                                            @can('read', $data)
                                                <a href="{{ route('voyager.modals.show', $data->{$data->getKeyName()}) }}" title="{{ __('voyager::generic.view') }}" class="btn btn-sm btn-warning pull-right">
