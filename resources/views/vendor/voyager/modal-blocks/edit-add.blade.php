            ...
            <div class="col-md-3 col-lg-2">
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" action="{{ route('voyager.modal-blocks.store', $page->id) }}" method="POST"
                            ...
                            <input type="hidden" name="modal_id" value="{{ $page->id }}"/>
                    ...
                    <ol class="dd-list">
                        @foreach($pageBlocks as $block)
                            ...
                            @if ($block->type === 'template')
                                @include('voyager::modal-blocks.partials.template')
                            @else
                                @include('voyager::modal-blocks.partials.include')
                            @endif
                        @endforeach
                    </ol> <!-- /.dd-list -->
                </div> <!-- /.dd -->
    ...
    <script>
        $('document').ready(function () {
            ...
            $(document).on('click', '.panel-heading [data-toggle="block-collapse"]', function (e) {
                ...
                $.post('{{ route('voyager.modal-blocks.minimize') }}', {
            ...
            $('.dd').on('change', function (e) {
                ...
                if ($('.dd').hasClass('dd-dragging')) {
                    ...
                    // Post the request
                    $.post('{{ route('voyager.modal-blocks.sort') }}', {
